...
export default function AdminLayout({
    ...
    useEffect(() => {
        ...
        if (!admin && pathname !== '/shreenath/login') {
            router.push('/shreenath/login');
        } else {
    ...
    if (!isAuthenticated && pathname !== '/shreenath/login') {
        return null; // Or a loading spinner
    }

    if (pathname === '/shreenath/login') {
        return <>{children}</>;
    }

    const navItems = [
        { name: 'Dashboard', href: '/shreenath', icon: LayoutDashboard },
        { name: 'Products', href: '/shreenath/products', icon: Package },
        { name: 'Messages', href: '/shreenath/contacts', icon: MessageSquare },
    ];
