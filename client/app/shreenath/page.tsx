    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                <Link href="/shreenath/products" className="block p-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                ...
                <Link href="/shreenath/contacts" className="block p-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex items-center space-x-4">
